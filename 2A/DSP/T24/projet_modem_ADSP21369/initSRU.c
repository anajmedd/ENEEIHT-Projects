...
// Route SPI signals to AD1835.
    ...
    SRU(SPI_MOSI_O,DPI_PB01_I)      // pas de ; ????   Connect MOSI to DPI PB1.
    SRU(DPI_PB02_O, SPI_MISO_I)     // pas de ; ????   Connect DPI PB2 to MISO.
    SRU(SPI_CLK_O, DPI_PB03_I)      // pas de ; ????   Connect SPI CLK to DPI PB3.

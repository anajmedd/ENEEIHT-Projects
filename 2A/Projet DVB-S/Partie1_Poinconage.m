...
%
%--------------------------------------------------------------------------
% Implantation de la chaine de Transimission
%--------------------------------------------------------------------------
...
ak = 2*convenc(bits(1:2:end),trellis)-1;
bk = 2*convenc(bits(2:2:end),trellis)-1;
dk = ak + 1j * bk;
...
for i = 0 : 8
    ...
    decoded1 = vitdec(ak_dec,trellis,35,'trunc','Hard');
    decoded2 = vitdec(bk_dec,trellis,35,'trunc','Hard');
    bits_decides = bits;
